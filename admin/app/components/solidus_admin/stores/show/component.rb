...
class SolidusAdmin::Stores::Show::Component < SolidusAdmin::BaseComponent
  include SolidusAdmin::Layout::PageHelpers

	# Define the necessary attributes for the component
	attr_reader :store, :form_id, :available_countries

	# Initialize the component with required data
	def initialize(store:, form_id: "store-form")
		@store = store
